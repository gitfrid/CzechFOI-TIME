...
def main():
    ...
    plt = {   
        "title_text": "1st and 2nd Derivate",         
    ...
    # color_palette = px.colors.qualitative.Set1  # Set1 is a qualitative color palette with distinct colors

    # Custom color palette (11 color pairs)
    color_palette = [
        '#db5f57', '#f1cdbc', '#dba757', '#f1eabc', '#c7db57', '#daf1bc',
        '#7fdb57', '#bdf1bc', '#57db77', '#bcf1d7', '#57dbbf', '#bcedf1',
        '#57afdb', '#bcd1f1', '#5767db', '#c4bcf1', '#8f57db', '#e1bcf1',
        '#d757db', '#f1bce4', '#db5797', '#f1bcc7'
    ]
    ...
    def generate_shades(base_color, num_shades=5, lightness_factor=0.1):
        ...
        if base_color.startswith("#"):
            base_color = mcolors.hex2rgb(base_color)
