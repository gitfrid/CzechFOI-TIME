...
def main():
    ...
    plt = {   
        "title_text": "rolling perason for 2nd Derivate",         
    ...
    pairs = [
        ('Avg 2D NUM_D', 'Avg 2D NUM_DUVX'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_DVX'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_DVD1'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_DVD2'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_DVDA'),       
        ('Avg 2D NUM_D', 'Avg 2D NUM_UVX'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_VX'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_D', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_DVX'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_DVD1'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_DVD2'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_DVDA'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_UVX'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_VX'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_DUVX', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_DVD1'),
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_DVD2'),
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_DVDA'),
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_UVX'),
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_VX'),
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_DVX', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_DVD1', 'Avg 2D NUM_DVD2'),
        ('Avg 2D NUM_DVD1', 'Avg 2D NUM_DVDA'),
        ('Avg 2D NUM_DVD1', 'Avg 2D NUM_UVX'),
        ('Avg 2D NUM_DVD1', 'Avg 2D NUM_VX'),
        ('Avg 2D NUM_DVD1', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_DVD1', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_DVD1', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_DVD2', 'Avg 2D NUM_DVDA'),
        ('Avg 2D NUM_DVD2', 'Avg 2D NUM_UVX'),
        ('Avg 2D NUM_DVD2', 'Avg 2D NUM_VX'),
        ('Avg 2D NUM_DVD2', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_DVD2', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_DVD2', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_DVDA', 'Avg 2D NUM_UVX'),
        ('Avg 2D NUM_DVDA', 'Avg 2D NUM_VX'),
        ('Avg 2D NUM_DVDA', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_DVDA', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_DVDA', 'Avg 2D NUM_VDA'),
        
        
        ('Avg 2D NUM_UVX', 'Avg 2D NUM_VX'),
        ('Avg 2D NUM_UVX', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_UVX', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_UVX', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_VX', 'Avg 2D NUM_VD1'),
        ('Avg 2D NUM_VX', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_VX', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_VD1', 'Avg 2D NUM_VD2'),
        ('Avg 2D NUM_VD1', 'Avg 2D NUM_VDA'),
        
        ('Avg 2D NUM_VD2', 'Avg 2D NUM_VDA')
    ]
