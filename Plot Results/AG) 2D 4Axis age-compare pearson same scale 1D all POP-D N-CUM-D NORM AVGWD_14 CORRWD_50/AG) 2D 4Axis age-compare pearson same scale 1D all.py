...
def main():
    ...
    plt = {   
        "title_text": "rolling perason for 1st Derivate same scale",         
    ...
    for age_band_pair in age_band_compare:    
        ...
        for idx, age_band in enumerate(age_band_pair):  # Loop through each individual age band in the tuple
            ...
            fig.update_layout(
                ...
                yaxis3=dict(title='Cumulative Values y3 DVD', overlaying="y", position=0.9, side="right",autorange=True),
                yaxis4=dict(title='Cumulative Values y4 VD', overlaying="y", side="right",autorange=True),
                yaxis5=dict(title='1st and 2nd Derivative y5 DVD', overlaying="y", side="left", position=0.15,autorange=True),  # First derivative y5
                yaxis6=dict(title='1st and 2nd Derivative y6 VD', overlaying="y", side="left", position=0.25,autorange=True),   # Second derivative y6
            ...
            for j in range(start, end):  
                ...
                if j % 10 == 0 or j % 10 == 1:      # y1                    
                    ...
                    fig.data[j].update(yaxis='y5')  # First and second derivative of DVD
                        ...
                        # debug print(f"y3 {idx}: {j}: {fig.data[j].name}") 
                        fig.data[j].update(yaxis='y3')  # cumulated  
                        ...
                        # debug print(f"y4 {idx}: {j}: {fig.data[j].name}") 
                        fig.data[j].update(yaxis='y4')  # cumulated 
            ...
            if idx == 0:  # First age band - Use y1 to y7                
                ...
                # Additional correlation traces for the second age band should use same axis y7
