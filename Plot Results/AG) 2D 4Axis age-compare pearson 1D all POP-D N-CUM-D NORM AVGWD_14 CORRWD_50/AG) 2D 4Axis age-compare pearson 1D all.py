        ...
        for idx, age_band in enumerate(age_band_pair):  # Loop through each individual age band in the tuple
            ...
            for i in range(0, len(dataframes_dvd)):
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'{os.path.splitext(os.path.basename(csv_files_dvd[i]))[0][4:]} {age_band[:2]}'
                ), secondary_y=False)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'Avg {os.path.splitext(os.path.basename(csv_files_dvd[i]))[0][4:]} {age_band[:2]}',
                    showlegend=True
                ), secondary_y=False)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'Avg 1D {os.path.splitext(os.path.basename(csv_files_dvd[i]))[0][4:]} {age_band[:2]}',
                    showlegend=True
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'Avg 2D {os.path.splitext(os.path.basename(csv_files_dvd[i]))[0][4:]} {age_band[:2]}',
                    showlegend=True
                ), secondary_y=True)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'cum {os.path.splitext(os.path.basename(csv_files_dvd[i]))[0][4:]} {age_band[:2]}'
                ), secondary_y=True)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'{os.path.splitext(os.path.basename(csv_files_vd[i]))[0][4:]} {age_band[:2]}'
                ), secondary_y=False)            
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'Avg {os.path.splitext(os.path.basename(csv_files_vd[i]))[0][4:]} {age_band[:2]}',
                    showlegend=True
                ), secondary_y=False)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'Avg 1D {os.path.splitext(os.path.basename(csv_files_vd[i]))[0][4:]} {age_band[:2]}',
                    showlegend=True
                ), secondary_y=True)  
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'Avg 2D {os.path.splitext(os.path.basename(csv_files_vd[i]))[0][4:]} {age_band[:2]}',
                    showlegend=True
                ), secondary_y=True)
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'cum {os.path.splitext(os.path.basename(csv_files_vd[i]))[0][4:]} {age_band[:2]}'
                ), secondary_y=True)
                # debug print(f'Tr = {len(fig.data)}')

            # colors for rolling correlation curves 
            ...
            for i, (name1, name2) in enumerate(pairs):
                try:
                    ...
                    name1 = f"{name1} {age_band[:2]}"
                    name2 = f"{name2} {age_band[:2]}"
                    df1 = data[name1]
                    df2 = data[name2]
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name=f'COR {name1}<br>{name2} {age_band[:2]}'
                ), secondary_y=True)
                # debug print(f'corr i = {i}')             
            ...
            # Additional traces for the first age band should use y7
